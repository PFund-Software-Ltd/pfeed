...
class FileIO(BaseIO, ABC):
    ...
    def _get_pyarrow_file_metadata(self, file_path: FilePath) -> PyArrowParquetFileMetaData:
    ...
    def _write_pyarrow_table(self, table: pa.Table, file_path: FilePath, **io_kwargs: Any):
