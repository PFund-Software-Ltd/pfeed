...
import pfeed as pe
from pfeed.const.enums import DataSource, DataType, ProductType, DataStorage, DataLayer
...
@click.option('--data-layer', '--dl', 'data_layer', default='cleaned', type=click.Choice([level.name for level in DataLayer], case_sensitive=False), help='Data layer, e.g. "raw", "cleaned", or "curated"')
...
def download(data_source, products, ptypes, dtype, start_date, end_date, data_layer, storage, num_cpus, no_ray, use_prefect, data_path, env_file_path, debug):
