...
class TimeBasedDataModel(BaseDataModel):
    ...
    @classmethod
    def _validate_end_date(cls, end_date: datetime.date, info: ValidationInfo) -> datetime.date:
    ...
    def dates(self) -> list[datetime.date]:
        import polars as pl
        return pl.date_range(self.start_date, self.end_date, interval="1d", eager=True).to_list()
