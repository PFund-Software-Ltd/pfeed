...
FMPDataFeed = FMPNewsFeed | FMPEconomicsFeed | FMPAnalystFeed | FMPMarketFeed
...
class FinancialModelingPrep:
    def __init__(
        ...
        params = {
            ...
            if k not in ["self", "api_key", "fmp_plan"]
        }
        params["data_source"] = FinancialModelingPrepSource(
            api_key=api_key, fmp_plan=fmp_plan
        )
